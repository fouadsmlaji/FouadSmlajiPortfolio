const ProjectsData = [
  {
    id: "1",
    title: "Project I: E-Commerce Website",
    path: "/projects/1",
    num: "I",
    description:
      "An e-commerce website featuring an admin dashboard for managing users, products, and permissions. It includes roles for admins, editors, and product managers, allowing them to create, edit, and delete products and users. The platform supports authentication, including Google login integration.",
    images: [
      "/public/assets/images/EcommerceWebsite/image1.png",
      "/public/assets/images/EcommerceWebsite/image2.png",
      "/public/assets/images/EcommerceWebsite/image3.png",
      "/public/assets/images/EcommerceWebsite/image4.png",
    ],
  ...
  {
    id: "2",
    title: "Project II: Majd Alghaith Photography",
    path: "/projects/2",
    num: "II",
    description:
    ...
    images: [
      "/public/assets/images/MajdWebsite/image1.png",
      "/public/assets/images/MajdWebsite/image2.png",
      "/public/assets/images/MajdWebsite/image3.png",
      "/public/assets/images/MajdWebsite/image4.png",
    ],
    link: "https://github.com/fouadsmlaji/MA-Website",
  },
  {
    id: "3",
    title: "Project III: Tasking Dev",
    path: "/projects/3",
    num: "III",
    description:
    ...
    images: [
      "/public/assets/images/TaskingDevWebsite/image1.png",
      "/public/assets/images/TaskingDevWebsite/image2.png",
      "/public/assets/images/TaskingDevWebsite/image3.png",
      "/public/assets/images/TaskingDevWebsite/image4.png",
    ],
    link: "https://github.com/fouadsmlaji/Task.Dev-website",
  },
  {
    id: "4",
    title: "Project IV: Alessandra Parisi Sito",
    path: "/projects/4",
    num: "IV",
    description:
      "This website serves as a dynamic showcase for the renowned artist Alessandra Parisi, highlighting her diverse collection of artwork. The site features a range of her artistic creations, including stunning paintings, intricate icons, and various other art forms that demonstrate her unique creative vision and talent. With each piece, the website provides an immersive experience that allows visitors to explore the depth and beauty of Alessandra's work, offering a glimpse into her artistic journey and the passion that drives her craft.",

    images: [
      "/public/assets/images/AlessandraWebsite/image1.png",
      "/public/assets/images/AlessandraWebsite/image2.png",
      "/public/assets/images/AlessandraWebsite/image3.png",
      "/public/assets/images/AlessandraWebsite/image4.png",
    ],
    link: "https://github.com/Nicholass206/Alessandra-Parisi-Sito",
  },
  {
    id: "5",
    title: "Project V: Foodz Restaurant",
    path: "/projects/5",
    num: "V",
    description:
      "The aim of this project is to enhance the food ordering experience by making it more appealing and convenient. By allowing customers to simply scan a QR code, they can instantly access the restaurant's website, which features an eye-catching design. This enables them to browse through the menu with ease, streamlining the entire process. **** HOSTED ON: http://anai-vlxtixa4oernwzo7uqzf.s3-website-ap-southeast-2.amazonaws.com/index.html ****.",
    images: [
      "/public/assets/images/FoodzWebsite/image1.png",
      "/public/assets/images/FoodzWebsite/image2.png",
      "/public/assets/images/FoodzWebsite/image3.png",
      "/public/assets/images/FoodzWebsite/image4.png",
    ],
  ...
  { id: "6", title: "Project VI: My Holiday", path: "/projects/6", num: "VI", description:"A dedicated website designed for holiday apartment rentals, offering a seamless and user-friendly platform for travelers to find their ideal accommodations. The website showcases a variety of vacation apartments with detailed descriptions, high-quality images, and a list of amenities such as Wi-Fi, swimming pools, and more. It provides an intuitive search feature, allowing users to filter by location, price, and availability, ensuring a hassle-free booking experience. **** HOSTED ON: http://anai-51zrvrufnzdtvdbz7lhj.s3-website-ap-southeast-2.amazonaws.com/index.html ****",
    images: [
      "/public/assets/images/MyHolidayWebsite/image1.png",
      "/public/assets/images/MyHolidayWebsite/image2.png",
      "/public/assets/images/MyHolidayWebsite/image3.png",
      "/public/assets/images/MyHolidayWebsite/image4.png",
    ],
  ...
  { id: "7", title: "Project VII: Puma Pro", path: "/projects/7", num: "VII", description:"The Puma Pro Property Management System showcase website is designed to present a cutting-edge solution for property owners, managers, and real estate professionals. This platform highlights Puma Pro’s powerful features, including tenant management, automated rent collection, maintenance tracking, and financial reporting, all integrated into an intuitive and user-friendly interface. With a sleek and modern design, the website provides an in-depth look at how Puma Pro streamlines property management tasks, enhances operational efficiency, and improves tenant experiences. ",
    images: [
      "/public/assets/images/PumaProWebsite/image1.png",
      "/public/assets/images/PumaProWebsite/image2.png",
      "/public/assets/images/PumaProWebsite/image3.png",
      "/public/assets/images/PumaProWebsite/image4.png",
    ],
    link:"",
   },
  { id: "8", title: "Project VIII: Minimal Digital Agency", path: "/projects/8", num: "VIII", description: "Minimal Digital Agency is a modern and streamlined platform dedicated to providing high-quality static web page creation services. Our team of skilled developers specializes in building fast, lightweight, and aesthetically pleasing websites that ensure a strong and professional online presence. We focus on efficiency, simplicity, and performance, delivering static websites that are secure, optimized, and maintenance-free. Whether you need a landing page, a business showcase, or a portfolio website, we create tailored solutions that meet your specific needs. **** HOSTED ON: https://midi.agency/ **** ",
    images: [
      "/public/assets/images/MidiWebsite/image1.png",
      "/public/assets/images/MidiWebsite/image2.png",
      "/public/assets/images/MidiWebsite/image3.png",
      "/public/assets/images/MidiWebsite/image4.png",
    ],
